				  	...
				  	<form class="form-horizontal" id="form-containers">
			  			<div class="box-body">
			  				...
			  				<div class="form-group">
			  					...
			  					<div class="col-sm-3">
			  						<input type="text" class="form-control" name="input-container" id="input-container" maxlength="10" required>
			  					</div>
			  				</div>
			  				...
			  				<div class="form-group">
			  					...
			  					<div class="col-sm-10">
			  						<input type="number" class="form-control" name="input-weight" id="input-weight" required>
			  					</div>
			  				</div>
			  				...
			  				<div class="form-group">
			  					...
			  					<div class="col-sm-10">
			  						<input type="number" class="form-control" name="input-value_payment" id="input-value_payment" required>
			  					</div>
			  				</div>
			  				...
			  				<div class="form-group">
			  					...
			  					<div class="col-sm-10">
			  						<input type="number" class="form-control" name="input-value_sale" id="input-value_sale" required>
			  					</div>
			  				</div>
...
<script>
	...
	$(document).ready(function()
	{
		$("#form-containers").submit(function(event) {
			...
			$.post(
				site_url + "/CContainers/addContainer",{
